        ...
        <div className="Contact">
            ...
            <div className="redDiv Contact-div">
                ...
                <div className="Contact-info">   
                    ...
                    <p>Website: <a href="https://www.miranda-manriquez.dev/" rel="noopener noreferrer" target="_blank" className="Contact-link">miranda-manriquez.dev</a></p>
                </div>
            </div>
        </div>
    )
